...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '---------------------------------------------------------------------------';
        PRINT 'Cleaning and inserting CRM Tables into Silver layer';
        PRINT '---------------------------------------------------------------------------';


        -- Clean & Load silver.crm_cust_info
        ...
        -- Clean & Load silver.crm_prd_info
        SET @start_time = GETDATE();
        ...
        -- Clean & Load silver.crm_sales_details
        SET @start_time = GETDATE();
        ...
        PRINT '---------------------------------------------------------------------------';
        PRINT 'Cleaning and inserting ERP Tables into Silver layer';
        PRINT '---------------------------------------------------------------------------';
        -- Clean & Load silver.erp_cust_az12 
        SET @start_time = GETDATE();
        ...
        -- Clean & Load silver.erp_loc_a101
        SET @start_time = GETDATE();
        ...
        -- Clean & Load silver.erp_px_cat_g1v2
        SET @start_time = GETDATE();
